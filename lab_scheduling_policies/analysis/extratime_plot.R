...
png(filename = "plots/wait_time40_p0.png", width = 600, height = 600, units = "px",res = 120)
...
png(filename = "plots/wait_time400_p0.png", width = 600, height = 600, units = "px",res = 120)
ggplot(plot.data, aes(x=group, y=value, group=group)) + geom_boxplot()
dev.off()
...
#Round Robin
rr_data = read.table("output/extra_time4000_rr.ffd", header = T)

png(filename = "plots/extra_time4000_rr.png", width = 600, height = 600, units = "px",res = 120)
extra_time_plot(rr_data)
dev.off()

png(filename = "plots/wait_time4000_rr.png", width = 600, height = 600, units = "px",res = 120)
wait_time_plot(rr_data)
dev.off()

#Priority Random
pr_data = read.table("output/extra_time4000_pr.ffd", header = T)

png(filename = "plots/extra_time4000_pr.png", width = 600, height = 600, units = "px",res = 120)
extra_time_plot(pr_data)
dev.off()

png(filename = "plots/wait_time4000_pr.png", width = 600, height = 600, units = "px",res = 120)
wait_time_plot(pr_data)
dev.off()

#XV6

xv6_data = read.table("output/extra_time4000_xv6.ffd", header = T)

png(filename = "plots/extra_time4000_xv6.png", width = 600, height = 600, units = "px",res = 120)
extra_time_plot(xv6_data)
dev.off()

png(filename = "plots/wait_time4000_xv6.png", width = 600, height = 600, units = "px",res = 120)
wait_time_plot(xv6_data)
dev.off()

#Kernel
kr_data = read.table("output/extra_time4000_kr.ffd", header = T)

png(filename = "plots/extra_time4000_kr.png", width = 600, height = 600, units = "px",res = 120)
extra_time_plot(kr_data)
dev.off()

png(filename = "plots/wait_time4000_kr.png", width = 600, height = 600, units = "px",res = 120)
wait_time_plot(kr_data)
dev.off()
...
png(filename = "plots/wait_time4000_p0.png", width = 600, height = 600, units = "px",res = 120)
ggplot(plot.data, aes(x=group, y=value, group=group)) + geom_boxplot()
dev.off()